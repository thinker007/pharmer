...
He then checks for the possible drug interactions by clicking the attributed button in Pharmer software and finds out that Sulfunyl Urea class drugs(here Glibenclamide) are not compatible to be coadministrated with beta-blockers(Atenolol). 
