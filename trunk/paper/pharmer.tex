...
\begin{abstract}
The recent proliferation of Linked Open Data enables the integration of multiple disparate data sources to shed some light on a new generation of knowledge management applications.
