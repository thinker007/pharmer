...
\begin{figure}[tb]
	\centering
		\includegraphics[width=1.0\columnwidth]{images/sc3.png}
...
\begin{figure}[tb]
	\centering
		\includegraphics[width=1.0\columnwidth]{images/sc4.png}
	\caption{Fact View showing the triples embedded in the prescription.}
	\label{fig:factview}
\end{figure}
