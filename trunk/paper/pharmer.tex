...
Through semantic  e-prescribing, all health care stakeholders including physicians, patients, pharmacists, researcher and drug companies benefit;
\begin{itemize}
...
\item Drug companies: Production efficacy, patient compliance and rate of each medicine consumption
\end{itemize}
...
Drug companies can take the advantage of Pharmer data in order to regulate their product with market demand.


Besides, Pharmer allows researchers to investigate about the patient complience of each individual medicine.
They are able to conveniently follow the drug in the post market clinical trial phase. 
Taking it into the consideration based on pharmer statistics, FDA decides on product release in th emarket.
Furthermore, Pharmer will develpes to the data resouce which is of interest for all staticians or researcher conducting comparisons among different drugs effect or efficacy.
